...
_See something wrong? Create an issue!_
...
* [Ultimate Lighting Controller Documentation](intro.md#ultimate-lighting-controller-documentation)
* [Features](intro.md#features)
* [ULC for Server Owners](intro.md#ulc-for-server-owners)
  * [How to Setup ULC in your Server](intro.md#how-to-setup-ulc-in-your-server)
    * [Installation](intro.md#installation)
    * [Configuration](intro.md#configuration)
      * [How to Import an Included Config File](intro.md#how-to-import-an-included-config-file)
      * [How to Manually Configure a Vehicle](intro.md#how-to-manually-configure-a-vehicle)
* [ULC for Vehicle Developers](intro.md#ulc-for-vehicle-developers)
  * [How to Share ULC Configurations with Users](intro.md#how-to-share-ulc-configurations-with-users)
  * [How to Create Vehicles for ULC](intro.md#how-to-create-vehicles-for-ulc)
    * [Extras with Sirens](intro.md#extras-with-sirens)
    * [Stage Controls](intro.md#stage-controls)
      * [Example Usage](intro.md#example-usage)
      * [How to Create a Stage](intro.md#how-to-create-a-stage)
      * [Vehicle Stage Config](intro.md#vehicle-stage-config)
    * [Park Patterns/Extras](intro.md#park-patternsextras)
      * [How to Create a Park Pattern](intro.md#how-to-create-a-park-pattern)
      * [Park Config](intro.md#park-config)
      * [Vehicle Park Config](intro.md#vehicle-park-config)
    * [Cruise Lights/Steady Burns](intro.md#cruise-lightssteady-burns)
      * [How to Create Cruise Lights](intro.md#how-to-create-cruise-lights)
      * [Cruise Light Config](intro.md#cruise-light-config)
      * [Vehicle Cruise Light Config](intro.md#vehicle-cruise-light-config)
    * [Brake Patterns](intro.md#brake-patterns)
      * [How to Create Brake Patterns](intro.md#how-to-create-brake-patterns)
      * [Brake Pattern Config](intro.md#brake-pattern-config)
      * [Brake Pattern Vehicle Config](intro.md#brake-pattern-vehicle-config)
    * [Horn Patterns/Extras](intro.md#horn-patternsextras)
      * [Vehicle Horn Extras Config](intro.md#vehicle-horn-extras-config)
